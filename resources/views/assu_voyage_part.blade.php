...
@section('image_article', asset('/storage/images/assu-vyg-part-big-'. App::getLocale().'.webp'))
@section('content')
@php
  ...
  <div class="flex-wrapper">
    <div class="flex-item">
      <div class="container">
        ...
        <div class="col-12" id="quismnous" data-aos="fade-up">
          <img class="underline" src="{{ asset('assets/img/Line-green.png')}}" alt="Sépration">
        ...
        <div class="container">
          <div class="row" id="partenaires">
            ...
            <div class="col-6" id="text-prq-choisir" data-aos="fade-left">
              <img class="row underline" src="{{ asset('assets/img/Line-blue.png')}}" alt="Séparation">
      ...
      <div class="container">
        <div class="row" id="partenaires-small">
          ...
          <div class="col-12" id="text-prq-choisir" data-aos="fade-left">
            <img class="row underline" src="{{ asset('assets/img/Line-blue.png')}}" alt="">
            <h2>{{ __('assu_vyg_part.POURQUOI_SOUSCRIRE') }}</h2>
            <h3>{{ __('assu_vyg_part.ASSISTANCE_A_FAMILLE') }}</h3>
    ...
    <div class="flex-item">
      ...
      <div class="col-12" id="nosvaleurs" data-aos="fade-up">
        <img class="underline" src="{{ asset('assets/img/Line-green.png')}}" alt="">
            ...
            <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" style="width: 241px; background-image: linear-gradient(45deg, #01062C 0%, #00215F 100%);">
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul id="tunisie-submenu" class="dropdown-menu" style="width: 241px; background-image: linear-gradient(45deg, #01062C 0%, #00215F 100%);">
