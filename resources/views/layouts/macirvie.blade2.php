...
<body style="text-align: justify;" dir="{{(App::isLocale('ar') ? 'rtl' : 'ltr')}}">
    ...
    <div id="all_content">
        ...
        <div class="background">
            ...
            <nav class="header navbar navbar-expand-md navbar-dark bg-dark positionnement">
                ...
                <div class="collapse navbar-collapse flex-column " id="navbar">
                    ...
                    <div class="row" id="Bcg">
                        ...
                        <div class="respon-align" style="width:100%">
                            ...
                            <ul class="navbar-nav  w-100  bg px-3 b">
                                    <img
                                    src={{ asset('assets/img/Hlel02_MacirVie_Habillage.svg')}}
                                    class="b1"
                                  />
                                <div style="display: flex; justify-content: space-between;width: 100%;">
                                    ...
                                    <div style="display: flex;">
                                        <li class="nav-item dropdown col-md logo-parent" style=" width:fit-content;;display: flex; justify-content: center;  ">
                                            <a class="nav-link logo-parent abc" href="{{ route(app()->getLocale(). '-accueil')}}"><img style="justify-content: center;" id="logo" src="{{ asset('assets/img/macir2.png')}}" alt="Logo Macirvie"> <span class="sr-only">(current)</span></a>
                                        </li>
                                    </div>
                                    <div style="display: flex;  ">
              ...
              <a class="nav-link" href="#"><i class="fas fa-search svg-inline--fa fa-w-12" aria-hidden="true"></i><span class="sr-only">(current)</span></a>
                    ...
                    <ul class="navbar-nav justify-content-center w-100 bg-secondary px-3 a">
                            <img
                            src={{ asset('assets/img/Etoiles_menu_MacirVie_Habillage.svg')}}
                            class="a1"
                          />  
        ...
        <img class="row underline" src="{{ asset('assets/img/Line-white.png')}}">
                ...
                <div style="background-color: #002d70;" class="navbar-toggler-left">
                    ...
                    <div style=" display:flex; align-items: center; justify-content: center;">
                        ...
                        <a class="d-flex justify-content-center" style="margin-left: -50px;" href="{{ route(app()->getLocale(). '-accueil')}}">
                            <img id="logo-sc" src="{{ asset('assets/img/logo.png')}}" alt="Logo MacriVie">
                        </a>
                    </div>
        ...
        <div class="all-content-apart-navbar">
            ...
            @include('layouts/modalLivreBlanc')
            @yield('content')
