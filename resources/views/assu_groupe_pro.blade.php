...
@section('image_article',  asset('/storage/images/assu-group-big-'. App::getLocale().'.webp'))
@section('content')
@php
...
$sous_titre4 = $assuranceGroup->$sous_titre4;
      ...
      <div class="container">
        ...
        <div class="row" id="partenaires">
          ...
          <div class="col-6" id="text-prq-choisir" data-aos="fade-left">
            ...
            <br>
            <div id="mym_sante">
            <h3>{{ __('assu_groupe_pro.MYM_SANTE_PLUS_TITLE') }}</h3>
            <p>
            {{ __('assu_groupe_pro.MYM_SANTE_PLUS_CONTENT') }}
            </p>
            <ul>
            <li>{{ __('assu_groupe_pro.MYM_SANTE_PLUS_TEXT1') }}</li>
            <li>{{ __('assu_groupe_pro.MYM_SANTE_PLUS_TEXT2') }}</li>
            <li>{{ __('assu_groupe_pro.MYM_SANTE_PLUS_TEXT3') }}</li>
            <li>{{ __('assu_groupe_pro.MYM_SANTE_PLUS_TEXT4') }}</li>
            <li>{{ __('assu_groupe_pro.MYM_SANTE_PLUS_TEXT5') }}</li>
            </ul>
            </div>
            ...
            <div class="row flex-column justify-content-center align-items-center mt-0 mb-5 sous-simul pl-0">
                ...
                <div class="dropdown">
                    ...
                    <li class="dropdown-submenu">
                            ...
                            <ul id="groupe-submenu" class="dropdown-menu" style="width: 241px; background-image: linear-gradient(45deg, #01062C 0%, #00215F 100%);">
                        ...
                        <li  class="dropdown-submenu">
                            ...
                            <ul id="sante-submenu" class="dropdown-menu" style="width: 241px; background-image: linear-gradient(45deg, #01062C 0%, #00215F 100%);">
