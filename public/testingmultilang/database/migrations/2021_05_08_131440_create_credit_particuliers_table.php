...
class CreateCreditParticuliersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('credit_particuliers', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('credit_particuliers');
    }
}
