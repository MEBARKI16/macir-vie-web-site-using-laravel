...
<body>
    <div class="container p-5">
        <h1>Modifier les produits de la page particuliers</h1>
        <form action="/admin/particuliers/add" method="POST" class="mt-5" enctype="multipart/form-data">
            @csrf
            <h3>Ajouter un produit particulier</h3>
        ...
        <h3>Liste des produits particulier</h3>
                ...
                <tr>
                    ...
                    <td>
                        <div style="height: 150px;display: flex;justify-content: center;align-items: center">
                            ...
                            <form action="/admin/produits/particuliers/delete/{{$produit->id}}" method="POST">
                                @csrf
                                @method("DELETE")
