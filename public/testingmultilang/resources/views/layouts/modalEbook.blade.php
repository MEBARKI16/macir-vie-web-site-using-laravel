...
$("#form_presentation").submit(function(e){
    ...
    $("#body_presentation").html(`<p style="color:#fff;font-waight:bold">Veuillez patientez</p><img src="{{ asset('assets/img/green_loading.gif')}}" style="width:80px" />`);
    $.ajax({
        type: "POST",
        url: actionUrl,
        ...
        {
            if(data=="OK")
            $("#body_presentation").html(`<div style="background: #fff;padding: 10px;border-radius: 20px;"><span style='color:#00225e;font-weight:bold;'>
